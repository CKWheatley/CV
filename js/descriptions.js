document.addEventListener('DOMContentLoaded', () => {
    const start_date = '01/02/2023'; //change where required
    const end_date = new Date();
    const months_worked = daysdifference(start_date, end_date);  

    document.getElementById("currentjob").innerHTML = `${months_worked} Months`;
